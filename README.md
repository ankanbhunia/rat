...
chmod -R +x rat
cd rat
bash ./install_vscode.sh --version 4.22.1 --arch linux-amd64
...
# Current Time
29/07/2025, 10:18:40 pm (Europe/London, UTC+1:00)

# Context Window Usage
77,488 / 1,048.576K tokens used (7%)
...
## Download a file or git clone using a jumpserver
...
2. Add a new website (the registered domain) to https://dash.cloudflare.com/.
3. Change Nameservers in the domain register site.
4. Create a cert.pem using `./login_cloudflare.sh`
5. Done!
